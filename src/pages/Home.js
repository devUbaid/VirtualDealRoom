      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Hear from businesses that have successfully used our platform.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl shadow-md p-6 border border-gray-200 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg flex flex-col">
              <div className="flex-grow relative pt-6">
                <p className="text-gray-600 italic relative">
                  "The Virtual Deal Room platform has transformed how we negotiate and close business deals. The
                  real-time chat and document sharing features are game-changers."
                </p>
              </div>
              <div className="flex items-center pt-6 border-t border-gray-200 mt-6">
                <img
                  src="/placeholder.svg?height=60&width=60"
                  alt="John Smith"
                  className="w-12 h-12 rounded-full object-cover border-2 border-primary-500 mr-4"
                />
                <div>
            ...
            <div className="bg-white rounded-xl shadow-md p-6 border border-gray-200 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg flex flex-col">
              <div className="flex-grow relative pt-6">
                <p className="text-gray-600 italic relative">
                  "As a seller, I've been able to reach more buyers and close deals faster. The platform's security
                  features give my clients confidence in the process."
                </p>
              </div>
              <div className="flex items-center pt-6 border-t border-gray-200 mt-6">
                <img
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Sales Director, Global Enterprises</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-md p-6 border border-gray-200 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg flex flex-col">
              <div className="flex-grow relative pt-6">
                <p className="text-gray-600 italic relative">
                  "The transparency and security of the Virtual Deal Room have made our procurement process much more
                  efficient. We've reduced closing time by 40%."
                </p>
              </div>
              <div className="flex items-center pt-6 border-t border-gray-200 mt-6">
                <img
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Procurement Manager, Innovate Corp</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-primary-600 to-secondary-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto opacity-90">
            Join our platform today and experience secure, efficient business transactions.
          </p>
          ...
          {isAuthenticated ? (
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/register" className="btn btn-lg bg-white text-primary-600 hover:bg-gray-100">
                <i className="fas fa-user-plus mr-2"></i> Create Your Account
              </Link>
              <Link to="/login" className="btn btn-lg border-2 border-white text-white hover:bg-white/10">
                <i className="fas fa-sign-in-alt mr-2"></i> Login
              </Link>
